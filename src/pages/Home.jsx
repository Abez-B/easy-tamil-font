      ...
      <section className="hero-section border-b border-border">
        <div className="max-w-7xl mx-auto px-4 py-12 md:py-18 relative z-10">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col -space-y-4 md:-space-y-6 mb-4" aria-hidden="true">
              <div
                className="text-5xl md:text-6xl font-bold leading-[1.6] md:leading-[1.8] py-2 px-2 tracking-[0.08em] text-gradient transition-all duration-500"
